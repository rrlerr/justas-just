...
export default function ProductFormModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
      <div className="bg-white p-6 rounded-md shadow-xl w-full max-w-xl text-black relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <input name="badge" value={form.badge} onChange={handleChange} placeholder="Badge (optional)" className="input" />
